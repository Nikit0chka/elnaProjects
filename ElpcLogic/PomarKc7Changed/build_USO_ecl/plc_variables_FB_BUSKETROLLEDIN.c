...
int __variables_init_FB_BUSKETROLLEDIN(){
  ...
  { // 71375 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.PHASENUMBER
    st = getVariable(71375);
  ...
  { // 71376 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.RUN
    st = getVariable(71376);
  ...
  { // 71377 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.RESET
    st = getVariable(71377);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71378 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.START
    st = getVariable(71378);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71379 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.ERROR
    st = getVariable(71379);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71380 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.TOP
    st = getVariable(71380);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71381 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.STARTSTATUS
    st = getVariable(71381);
  ...
  { // 71382 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.ERRORSTATUS
    st = getVariable(71382);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 71383 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.TOPSTATUS
    st = getVariable(71383);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 71384 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.COMMANDFAULT_TRIG.CLK
    st = getVariable(71384);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71385 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.COMMANDFAULT_TRIG.Q
    st = getVariable(71385);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71386 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.COMMANDFAULT_TRIG
    st = getVariable(71386);
  ...
  { // 71387 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.RESET_TRIG.CLK
    st = getVariable(71387);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71388 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.RESET_TRIG.Q
    st = getVariable(71388);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 71389 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.RESET_TRIG
    st = getVariable(71389);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 71390 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(71390);
  ...
  { // 71391 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_ON
    st = getVariable(71391);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 71392 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(71392);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 71393 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(71393);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 71394 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(71394);
    memcpy(st->IEC_TYPE, "BYTE", 4);
