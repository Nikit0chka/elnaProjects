...
int __variables_init_FB_TESTUNSUCCESSFULUNFILL(){
  ...
  { // 97605 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.PHASENUMBER
    st = getVariable(97605);
  ...
  { // 97606 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.RUN
    st = getVariable(97606);
  ...
  { // 97607 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.RESET
    st = getVariable(97607);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97608 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.START
    st = getVariable(97608);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97609 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.ERROR
    st = getVariable(97609);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97610 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.TOP
    st = getVariable(97610);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97611 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.STARTSTATUS
    st = getVariable(97611);
  ...
  { // 97612 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.ERRORSTATUS
    st = getVariable(97612);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 97613 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.TOPSTATUS
    st = getVariable(97613);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 97614 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.COMMANDFAULT_TRIG.CLK
    st = getVariable(97614);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97615 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.COMMANDFAULT_TRIG.Q
    st = getVariable(97615);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97616 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.COMMANDFAULT_TRIG
    st = getVariable(97616);
  ...
  { // 97617 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.RESET_TRIG.CLK
    st = getVariable(97617);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97618 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.RESET_TRIG.Q
    st = getVariable(97618);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 97619 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.RESET_TRIG
    st = getVariable(97619);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 97620 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(97620);
  ...
  { // 97621 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_ON
    st = getVariable(97621);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 97622 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(97622);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 97623 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(97623);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 97624 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(97624);
    memcpy(st->IEC_TYPE, "BYTE", 4);
