...
int __variables_init_FB_TESTUNSUCCESSFULUNFILL(){
  ...
  { // 92190 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.PHASENUMBER
    st = getVariable(92190);
  ...
  { // 92191 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.RUN
    st = getVariable(92191);
  ...
  { // 92192 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.RESET
    st = getVariable(92192);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92193 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.START
    st = getVariable(92193);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92194 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.ERROR
    st = getVariable(92194);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92195 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.TOP
    st = getVariable(92195);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92196 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.STARTSTATUS
    st = getVariable(92196);
  ...
  { // 92197 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.ERRORSTATUS
    st = getVariable(92197);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 92198 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.STRPH.TOPSTATUS
    st = getVariable(92198);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 92199 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.COMMANDFAULT_TRIG.CLK
    st = getVariable(92199);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92200 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.COMMANDFAULT_TRIG.Q
    st = getVariable(92200);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92201 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.COMMANDFAULT_TRIG
    st = getVariable(92201);
  ...
  { // 92202 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.RESET_TRIG.CLK
    st = getVariable(92202);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92203 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.RESET_TRIG.Q
    st = getVariable(92203);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 92204 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL.RESET_TRIG
    st = getVariable(92204);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 92205 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(92205);
  ...
  { // 92206 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_ON
    st = getVariable(92206);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 92207 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(92207);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 92208 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(92208);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 92209 PROGRAM0.ALGORITMS_PROC.FB_PUSKKALG.FB_TESTUNSUCCESSFULUNFILL._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(92209);
    memcpy(st->IEC_TYPE, "BYTE", 4);
