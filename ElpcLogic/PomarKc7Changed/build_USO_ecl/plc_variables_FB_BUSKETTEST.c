...
int __variables_init_FB_BUSKETTEST(){
  ...
  { // 73076 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.PHASENUMBER
    st = getVariable(73076);
  ...
  { // 73077 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.RUN
    st = getVariable(73077);
  ...
  { // 73078 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.RESET
    st = getVariable(73078);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73079 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.START
    st = getVariable(73079);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73080 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.ERROR
    st = getVariable(73080);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73081 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.TOP
    st = getVariable(73081);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73082 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.STARTSTATUS
    st = getVariable(73082);
  ...
  { // 73083 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.ERRORSTATUS
    st = getVariable(73083);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 73084 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.STRPH.TOPSTATUS
    st = getVariable(73084);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 73085 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.COMMANDFAULT_TRIG.CLK
    st = getVariable(73085);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73086 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.COMMANDFAULT_TRIG.Q
    st = getVariable(73086);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73087 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.COMMANDFAULT_TRIG
    st = getVariable(73087);
  ...
  { // 73088 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.RESET_TRIG.CLK
    st = getVariable(73088);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73089 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.RESET_TRIG.Q
    st = getVariable(73089);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 73090 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST.RESET_TRIG
    st = getVariable(73090);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 73091 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(73091);
  ...
  { // 73092 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST._STATUSDUALINPUT.STATUS_ON
    st = getVariable(73092);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 73093 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(73093);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 73094 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(73094);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 73095 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETTEST._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(73095);
    memcpy(st->IEC_TYPE, "BYTE", 4);
