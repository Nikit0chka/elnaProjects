...
int __variables_init_FB_BUSKETROLLEDIN(){
  ...
  { // 76369 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.PHASENUMBER
    st = getVariable(76369);
  ...
  { // 76370 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.RUN
    st = getVariable(76370);
  ...
  { // 76371 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.RESET
    st = getVariable(76371);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76372 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.START
    st = getVariable(76372);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76373 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.ERROR
    st = getVariable(76373);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76374 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.TOP
    st = getVariable(76374);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76375 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.STARTSTATUS
    st = getVariable(76375);
  ...
  { // 76376 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.ERRORSTATUS
    st = getVariable(76376);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 76377 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.STRPH.TOPSTATUS
    st = getVariable(76377);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 76378 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.COMMANDFAULT_TRIG.CLK
    st = getVariable(76378);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76379 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.COMMANDFAULT_TRIG.Q
    st = getVariable(76379);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76380 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.COMMANDFAULT_TRIG
    st = getVariable(76380);
  ...
  { // 76381 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.RESET_TRIG.CLK
    st = getVariable(76381);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76382 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.RESET_TRIG.Q
    st = getVariable(76382);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76383 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN.RESET_TRIG
    st = getVariable(76383);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 76384 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(76384);
  ...
  { // 76385 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_ON
    st = getVariable(76385);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76386 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(76386);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76387 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(76387);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76388 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_BUSKETROLLEDIN._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(76388);
    memcpy(st->IEC_TYPE, "BYTE", 4);
