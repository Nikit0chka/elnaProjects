...
int __variables_init_FB_OSEVOISDVIG_LEVO(){
  iec_var_t *st;
  ...
  { // 32926 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.SIGNAL.VALUE
    ...
    p_FB_SINGLESIGNAL = (FB_SINGLESIGNAL*)&p_PROC_IM->FB_OSEVOISDVIG_LEVO;
    p_TYPE_RELIABLEBIT = (TYPE_RELIABLEBIT*)&p_FB_SINGLESIGNAL->SIGNAL;
    p_BOOL = (BOOL*)&p_TYPE_RELIABLEBIT->VALUE;
    st->value_p = p_BOOL;
  }
  { // 32927 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.SIGNAL.RELIABILITY
  ...
  { // 32928 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.SIGNAL._INVERSED
  ...
  { // 32929 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.STR_SS.RELIABILITY
  ...
  { // 32930 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.STR_SS.INVERSE
  ...
  { // 32931 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.STR_SS.DELAYON
  ...
  { // 32932 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.STR_SS.DELAYOFF
  ...
  { // 32933 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.STR_SS.Q
  ...
  { // 32934 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.STR_SS.STATUS
  ...
  { // 32935 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.STR_SS.DISABLED_SIG
  ...
  { // 32936 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMERON.IN
  ...
  { // 32937 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMERON.PT
  ...
  { // 32938 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMERON.Q
  ...
  { // 32939 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMERON.ET
  ...
  { // 32940 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMERON
  ...
  { // 32941 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMEROFF.IN
  ...
  { // 32942 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMEROFF.PT
  ...
  { // 32943 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMEROFF.Q
  ...
  { // 32944 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMEROFF.ET
  ...
  { // 32945 PROGRAM0.IM_PROC.FB_OSEVOISDVIG_LEVO.TIMEROFF
