...
int __variables_init_FB_DI_OK(){
  ...
  { // 75989 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.PHASENUMBER
    st = getVariable(75989);
  ...
  { // 75990 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.RUN
    st = getVariable(75990);
  ...
  { // 75991 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.RESET
    st = getVariable(75991);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 75992 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.START
    st = getVariable(75992);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 75993 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.ERROR
    st = getVariable(75993);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 75994 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.TOP
    st = getVariable(75994);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 75995 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.STARTSTATUS
    st = getVariable(75995);
  ...
  { // 75996 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.ERRORSTATUS
    st = getVariable(75996);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 75997 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.STRPH.TOPSTATUS
    st = getVariable(75997);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 75998 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.COMMANDFAULT_TRIG.CLK
    st = getVariable(75998);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 75999 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.COMMANDFAULT_TRIG.Q
    st = getVariable(75999);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76000 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.COMMANDFAULT_TRIG
    st = getVariable(76000);
  ...
  { // 76001 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.RESET_TRIG.CLK
    st = getVariable(76001);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76002 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.RESET_TRIG.Q
    st = getVariable(76002);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76003 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK.RESET_TRIG
    st = getVariable(76003);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 76004 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(76004);
  ...
  { // 76005 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK._STATUSDUALINPUT.STATUS_ON
    st = getVariable(76005);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76006 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(76006);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76007 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(76007);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76008 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_DI_OK._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(76008);
    memcpy(st->IEC_TYPE, "BYTE", 4);
