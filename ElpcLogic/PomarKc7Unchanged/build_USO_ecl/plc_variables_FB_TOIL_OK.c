...
int __variables_init_FB_TOIL_OK(){
  iec_var_t *st;
  ...
  { // 76049 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.PHASENUMBER
    st = getVariable(76049);
    ...
    p_FB_PH_CUSTOMPHASE = (FB_PH_CUSTOMPHASE*)&p_PPUALG->FB_TOIL_OK;
    p_UINT = (UINT*)&p_FB_PH_CUSTOMPHASE->PHASENUMBER;
    UnpackVar(p_UINT, UINT_ENUM, &st->value_p, &st->f_value_p, &st->flags);
  }
  { // 76050 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.RUN
    st = getVariable(76050);
  ...
  { // 76051 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.RESET
    st = getVariable(76051);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76052 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.START
    st = getVariable(76052);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76053 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.ERROR
    st = getVariable(76053);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76054 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.TOP
    st = getVariable(76054);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76055 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.STARTSTATUS
    st = getVariable(76055);
  ...
  { // 76056 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.ERRORSTATUS
    st = getVariable(76056);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 76057 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.STRPH.TOPSTATUS
    st = getVariable(76057);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 76058 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.COMMANDFAULT_TRIG.CLK
    st = getVariable(76058);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76059 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.COMMANDFAULT_TRIG.Q
    st = getVariable(76059);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76060 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.COMMANDFAULT_TRIG
    st = getVariable(76060);
  ...
  { // 76061 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.RESET_TRIG.CLK
    st = getVariable(76061);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76062 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.RESET_TRIG.Q
    st = getVariable(76062);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 76063 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK.RESET_TRIG
    st = getVariable(76063);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 76064 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(76064);
  ...
  { // 76065 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK._STATUSDUALINPUT.STATUS_ON
    st = getVariable(76065);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76066 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(76066);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76067 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(76067);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 76068 PROGRAM0.ALGORITMS_PROC.FB_PPUALG.FB_TOIL_OK._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(76068);
    memcpy(st->IEC_TYPE, "BYTE", 4);
