...
int __variables_init_FB_WAIT600(){
  ...
  { // 98289 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.DELAY
  ...
  { // 98290 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.PHASENUMBER
  ...
  { // 98291 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.RUN
  ...
  { // 98292 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.RESET
  ...
  { // 98293 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.START
  ...
  { // 98294 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.ERROR
  ...
  { // 98295 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.TOP
  ...
  { // 98296 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.STARTSTATUS
  ...
  { // 98297 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.ERRORSTATUS
    st = getVariable(98297);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 98298 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.STRPH.TOPSTATUS
    st = getVariable(98298);
    memcpy(st->IEC_TYPE, "DWORD", 5);
  ...
  { // 98299 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.COMMANDFAULT_TRIG.CLK
    st = getVariable(98299);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 98300 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.COMMANDFAULT_TRIG.Q
    st = getVariable(98300);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 98301 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.COMMANDFAULT_TRIG
    st = getVariable(98301);
  ...
  { // 98302 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.RESET_TRIG.CLK
    st = getVariable(98302);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 98303 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.RESET_TRIG.Q
    st = getVariable(98303);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 98304 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.RESET_TRIG
    st = getVariable(98304);
    memcpy(st->IEC_TYPE, "R_TRIG", 6);
  ...
  { // 98305 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600.TIMER
    st = getVariable(98305);
    memcpy(st->IEC_TYPE, "UINT", 4);
  ...
  { // 98306 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._TIMER.IN
    st = getVariable(98306);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 98307 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._TIMER.PT
    st = getVariable(98307);
    memcpy(st->IEC_TYPE, "TIME", 4);
  ...
  { // 98308 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._TIMER.Q
    st = getVariable(98308);
    memcpy(st->IEC_TYPE, "BOOL", 4);
  ...
  { // 98309 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._TIMER.ET
    st = getVariable(98309);
    memcpy(st->IEC_TYPE, "TIME", 4);
  ...
  { // 98310 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._TIMER
    st = getVariable(98310);
  ...
  { // 98311 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._STATUSDUALINPUT.STATUS_NOTDEFINED
    st = getVariable(98311);
  ...
  { // 98312 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._STATUSDUALINPUT.STATUS_ON
    st = getVariable(98312);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 98313 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._STATUSDUALINPUT.STATUS_OFF
    st = getVariable(98313);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 98314 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._STATUSDUALINPUT.STATUS_TRANSITIONAL
    st = getVariable(98314);
    memcpy(st->IEC_TYPE, "BYTE", 4);
  ...
  { // 98315 PROGRAM0.ALGORITMS_PROC.FB_PUSKVALG.FB_WAIT600._STATUSDUALINPUT.STATUS_ERROR
    st = getVariable(98315);
    memcpy(st->IEC_TYPE, "BYTE", 4);
